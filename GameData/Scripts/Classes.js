  ...
  draw() {
    ...
    if(this.type === 1 || this.type === 2){
      ...
      if(this.message.length > 0){
        ...
        var bubble_image = new HUD(bubble, this.x - ctx.measureText(this.message).width/2, this.y - this.height+18, 262, 94, 0, 0, 0, 0, 0, 262, 94, 0);
        bubble_image.draw();
        
        ctx.fillText(this.message, this.x - ctx.measureText(this.message).width/2, this.y - this.height+16);
      }
    }
  }
}
